...
const POIS = [
  ...
  { id: "spiaggia-canneto", name: "Spiaggia di Canneto", island: "Lipari",
    lat: 38.4845, lng: 14.9645, approx: true,
    type: "beach", depth: 4, depthText: "0–6 m — gentle pebble shelf",
    access: "shore", anchorage: "Canneto / Porticello",
    see: "Long pebble beach with easy entry; gentle shelving seabed.",
    notes: "Lipari's main beach town — lidos, rentals and restaurants. Busy in season.",
    desc: "Lipari's main beach — a long pebble strand at Canneto with lidos and easy access.",
  ...
  { id: "spiagge-bianche", name: "Spiagge Bianche", island: "Lipari",
    lat: 38.4930, lng: 14.9650, approx: true,
    type: "beach", depth: 4, depthText: "0–6 m — shallow white pumice seabed",
    access: "shore", anchorage: "Canneto / Porticello",
    see: "White pumice seabed giving Caribbean-style water colour; shallow and bright.",
    notes: "North of Canneto. Chairs available. The 'white' is pale grey pumice. Shallow seabed ideal for relaxed swimming.",
    desc: "Pale pumice beach north of Canneto where the white seabed turns the water tropical turquoise.",
    sources: [["Lonely Planet Italia — Eolie beaches", "https://www.lonelyplanetitalia.it/articoli/mare-e-spiagge/isole-eolie-spiagge-piu-belle"]] },
  { id: "spiaggia-porticello", name: "Spiaggia di Porticello (Papesca)", island: "Lipari",
    lat: 38.5085, lng: 14.9620, approx: true,
    type: "beach", depth: 5, depthText: "0–8 m — pumice and obsidian seabed",
    access: "shore", anchorage: "Canneto / Porticello",
    see: "Beach below the old pumice quarries; obsidian chunks still wash up; blinding white pebbles.",
    notes: "Sheltered between two rock spurs. Combine with the Pumice Canyon snorkel just north.",
    desc: "Pebble beach below Lipari's old pumice quarries — look for washed-up obsidian.",
    sources: [["Burgess — Aeolian island hopping", "https://www.burgessyachts.com/en/editorial/news/aeolian-island-hopping"]] },
  { id: "spiaggia-acquacalda", name: "Spiaggia di Acquacalda", island: "Lipari",
    lat: 38.5230, lng: 14.9430, approx: true,
    type: "beach", depth: 5, depthText: "0–8 m — pebbles, quiet water",
    access: "shore", anchorage: "Canneto / Porticello (around the point)",
    see: "Long quiet pebble beach on Lipari's north shore facing Salina; pumice cliffs to the east.",
    notes: "Much quieter than Canneto. Exposed to N winds — check conditions.",
    desc: "Lipari's quiet north-shore beach facing Salina, backed by the white pumice coast.",
    sources: [["sicilia.info — Lipari", "https://www.sicilia.info/en/aeolian-islands/lipari/"]] },
  { id: "sabbie-nere", name: "Spiaggia delle Sabbie Nere", island: "Vulcano",
    lat: 38.4192, lng: 14.9530, approx: true,
    type: "beach", depth: 4, depthText: "0–6 m — black sand, gentle shelf",
    access: "shore", anchorage: "Porto di Ponente",
    see: "The Aeolians' signature black-sand beach; Scoglio delle Sirene rock just offshore; sunset side.",
    notes: "Vulcano's most famous beach, in Porto Ponente bay. Busy but spacious. Easy walk from Porto Levante across the isthmus.",
  ...
  { id: "spiaggia-cannitello", name: "Spiaggia del Cannitello", island: "Vulcano",
    lat: 38.3740, lng: 14.9880, approx: true,
    type: "beach", depth: 5, depthText: "0–8 m — black sand crescent",
    access: "shore", anchorage: "Gelso",
    see: "Black-sand half-moon cove just before Gelso, reached by a path down to the sea; small lido in season.",
    notes: "Far quieter than the north coast. Combine with lunch at Trattoria da Pina in Gelso.",
    desc: "A quiet black-sand crescent near Gelso on Vulcano's south coast, with a small seasonal lido.",
    sources: [["Lonely Planet Italia — Eolie beaches", "https://www.lonelyplanetitalia.it/articoli/mare-e-spiagge/isole-eolie-spiagge-piu-belle"]] },
  { id: "spiaggia-faro-gelso", name: "Spiaggetta del Faro di Gelso", island: "Vulcano",
    lat: 38.3680, lng: 14.9990, approx: true,
    ...
    notes: "Small and uncrowded even in August. Rocky entry — reef shoes help.",
  ...
  { id: "spiaggia-ficogrande", name: "Spiaggia di Ficogrande", island: "Stromboli",
    lat: 38.8077, lng: 15.2385, approx: true,
    type: "beach", depth: 4, depthText: "0–6 m — black sand and pebbles",
    access: "shore", anchorage: "Ficogrande / Punta Lena",
    see: "Black volcanic beach facing Strombolicchio; the classic Stromboli swim with the sea stack on the horizon.",
    notes: "Rockier than Spiaggia Lunga. Lidos and kayak rental in season.",
    desc: "Stromboli's main black beach at Ficogrande, looking straight out at Strombolicchio.",
    sources: [["Adventurous Kate — Aeolian guide", "https://www.adventurouskate.com/aeolian-islands-sicily-travel-guide/"]] },
  { id: "spiaggia-lingua", name: "Spiaggia di Lingua", island: "Salina",
    lat: 38.5385, lng: 14.8705, approx: true,
    type: "beach", depth: 4, depthText: "0–6 m — pebbles by the salt lagoon",
    access: "shore", anchorage: "Santa Marina Salina (2.5 km)",
    see: "Pebble beach by the lighthouse and old salt lagoon; calm clear water; granita at Il Gambero afterwards.",
    notes: "Flat walk or cycle from Santa Marina. The lagoon is a birdlife spot.",
    desc: "Pebble beach beside Lingua's salt lagoon and lighthouse — pair a swim with the Aeolians' best granita.",
    sources: [["Adventurous Kate — Aeolian guide", "https://www.adventurouskate.com/aeolian-islands-sicily-travel-guide/"]] },
  { id: "spiaggia-pecorini", name: "Pecorini a Mare", island: "Filicudi",
    lat: 38.5580, lng: 14.5650, approx: true,
    ...
    sources: [["sicilia.info — Filicudi", "https://www.sicilia.info/en/aeolian-islands/filicudi/"]] },
  { id: "spiaggia-bazzina", name: "Spiaggia di Bazzina", island: "Alicudi",
    lat: 38.5430, lng: 14.3640, approx: true,
    type: "beach", depth: 5, depthText: "0–8 m — wild pebble cove",
    access: "boat", anchorage: "Alicudi (N of the port)",
    see: "Alicudi's only real beach — a wild pebble cove on the NE coast; total solitude; very clear water.",
    notes: "Reach by boat or a rough path north from the port. No facilities at all.",
    desc: "A wild, facility-free pebble cove on Alicudi's NE coast — solitude guaranteed.",
    sources: [["Apartment in Catania — Alicudi", "https://www.apartmentincatania.com/en/alicudi-island/"]] }
];
